  ...
  return (
    <div className="single-page">
      <div className="content">
        <img
          src="https://images.pexels.com/photos/17814830/pexels-photo-17814830/free-photo-of-beekeeper-working-in-an-apiary.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
          alt=""
        />
        <div className="user">
          <img
            src="https://images.pexels.com/photos/17774309/pexels-photo-17774309/free-photo-of-smiling-man-in-jacket-and-with-camera.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
            alt=""
          />
          <div className="info">
            <span>UserName</span>
            <p>Posted 12hrs ago.</p>
          </div>
          <div className="edit">
            <Link to={`/write?edit=2`} k>
              <img src={Edit} alt="" />
            </Link>
            <img src={Delete} alt="" />
          </div>
